...
--
-- Host: localhost
-- Generation Time: Dec 24, 2018 at 03:42 AM
...
INSERT INTO `course` (`courseIndex`, `courseName`, `courseCredit`, `program`) VALUES
('CSII200', 'Алгоритмын үндэс', 3, 'D061301'),
('CSII202', 'Өгөгдлийн сангийн үндэс', 3, 'D061301'),
('CSII203', 'Интернэт технологийн үндэс', 3, 'D061301'),
('ICSI201', 'Объект хандлагат програмчлал', 3, 'D061302'),
('ICSI202', 'Өгөгдлийн бүтэц', 3, 'D061303'),
('ICSI203', 'Магадлал статистик', 3, 'D061304'),
('ICSI301', 'Веб програмчлал', 3, 'D061303'),
('ICSI432', 'Компьютер график', 3, 'D061302');
...
('16b1seas3369', 'CSII203', '2018-12-20 16:56:28'),
...
('16b1seas3369', 'temuujinya', 'Temuujin', 'Ya', 'm', '1998-01-01', 'D061303'),
...
ALTER TABLE `course`
  ...
  ADD KEY `FK_COURSE_PROGRAM` (`program`);
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `FK_COURSE_PROGRAM` FOREIGN KEY (`program`) REFERENCES `program` (`programIndex`);
